...
const MMAS_QUESTIONS = {
  ...
  "pt-BR":{"name":"Portuguese (Brazil)","native":"Português (Brasil)","dir":"ltr","q1":"Às vezes você esquece de tomar seus comprimidos de {{COND}}?","q2":"As pessoas às vezes não tomam seus medicamentos por razões além do esquecimento. Nas últimas duas semanas, houve dias em que você não tomou seu medicamento {{COND}}?","q3":"Você já reduziu ou parou de tomar seus medicamentos sem contar ao seu médico, porque se sentiu pior quando os tomou?","q4":"Quando você viaja ou sai de casa, às vezes esquece de trazer seu medicamento {{COND}} junto?","q5":"Você tomou seu medicamento {{COND}} ontem?","q6":"Quando sente que seu {{COND}} está controlado, às vezes para de tomar seu medicamento?","q7":"Tomar medicamentos todos os dias é um grande inconveniente para algumas pessoas. Às vezes você se sente incomodado de seguir seu plano de tratamento {{COND}}?","q8":"Com que frequência você tem dificuldades em lembrar de tomar todos os seus medicamentos {{COND}}?","q1_yes":"Sim","q1_no":"Não","q8_never":"Nunca/Raramente","q8_once":"De vez em quando","q8_sometimes":"Às vezes","q8_usually":"Geralmente","q8_always":"O tempo todo"},
  ...
  "pl":{"name":"Polish","native":"Polski","dir":"ltr","q1":"Czy zdarza się Panu/Pani zapomnieć o wzięciu tabletek na {{COND}}?","q2":"Ludzie czasami nie przyjmują leków z powodów innych niż zapomnienie. Czy w ciągu ostatnich dwóch tygodni zdarzały się dni, w których nie przyjął(a) Pan(i) leku na {{COND}}?","q3":"Czy kiedykolwiek ograniczył(a) lub odstawił(a) Pan(i) lek bez informowania lekarza, ponieważ czuł(a) się Pan(i) gorzej po jego zażyciu?","q4":"Kiedy podróżuje Pan(i) lub wychodzi z domu, czy zdarza się zapomnieć o zabraniu leku na {{COND}}?","q5":"Czy wziął(a) Pan(i) lek na {{COND}} wczoraj?","q6":"Kiedy czuje Pan(i), że {{COND}} jest pod kontrolą, czy czasami odstawia Pan(i) lek?","q7":"Codzienne przyjmowanie leków stanowi dla niektórych osób poważne utrudnienie. Czy zdarza się Panu/Pani odczuwać trudność z przestrzeganiem planu leczenia {{COND}}?","q8":"Jak często ma Pan(i) trudności z przypominaniem sobie o wzięciu wszystkich leków na {{COND}}?","q1_yes":"Tak","q1_no":"Nie","q8_never":"Nigdy/Rzadko","q8_once":"Od czasu do czasu","q8_sometimes":"Czasami","q8_usually":"Zazwyczaj","q8_always":"Zawsze"},
  "pa":{"name":"Punjabi","native":"ਪੰਜਾਬੀ","dir":"ltr","q1":"ਕੀ ਤੁਸੀਂ ਕਦੇ-ਕਦੇ ਆਪਣੀਆਂ {{COND}} ਗੋਲੀਆਂ ਲੈਣਾ ਭੁੱਲ ਜਾਂਦੇ ਹੋ?","q2":"ਲੋਕ ਕਦੇ-ਕਦੇ ਭੁੱਲਣ ਤੋਂ ਇਲਾਵਾ ਹੋਰ ਕਾਰਨਾਂ ਕਰਕੇ ਆਪਣੀਆਂ ਦਵਾਈਆਂ ਲੈਣਾ ਛੱਡ ਦਿੰਦੇ ਹਨ। ਪਿਛਲੇ ਦੋ ਹਫ਼ਤਿਆਂ ਵਿੱਚ, ਕੀ ਅਜਿਹੇ ਕੋਈ ਦਿਨ ਸਨ ਜਦੋਂ ਤੁਸੀਂ ਆਪਣੀ {{COND}} ਦਵਾਈ ਨਹੀਂ ਲਈ?","q3":"ਕੀ ਤੁਸੀਂ ਕਦੇ ਆਪਣੇ ਡਾਕਟਰ ਨੂੰ ਦੱਸੇ ਬਿਨਾਂ ਦਵਾਈ ਘੱਟ ਕਰ ਦਿੱਤੀ ਜਾਂ ਬੰਦ ਕਰ ਦਿੱਤੀ ਕਿਉਂਕਿ ਜਦੋਂ ਤੁਸੀਂ ਇਸਨੂੰ ਲੈਂਦੇ ਸੀ ਤਾਂ ਬੁਰਾ ਮਹਿਸੂਸ ਕਰਦੇ ਸੀ?","q4":"ਜਦੋਂ ਤੁਸੀਂ ਯਾਤਰਾ ਕਰਦੇ ਹੋ ਜਾਂ ਘਰ ਤੋਂ ਬਾਹਰ ਜਾਂਦੇ ਹੋ, ਕੀ ਤੁਸੀਂ ਕਦੇ-ਕਦੇ ਆਪਣੀ {{COND}} ਦਵਾਈ ਨਾਲ ਲੈਣਾ ਭੁੱਲ ਜਾਂਦੇ ਹੋ?","q5":"ਕੀ ਤੁਸੀਂ ਕੱਲ੍ਹ ਆਪਣੀ {{COND}} ਦਵਾਈ ਲਈ ਸੀ?","q6":"ਜਦੋਂ ਤੁਸੀਂ ਮਹਿਸੂਸ ਕਰਦੇ ਹੋ ਕਿ ਤੁਹਾਡਾ {{COND}} ਕੰਟਰੋਲ ਵਿੱਚ ਹੈ, ਕੀ ਤੁਸੀਂ ਕਦੇ-ਕਦੇ ਆਪਣੀ ਦਵਾਈ ਲੈਣਾ ਬੰਦ ਕਰ ਦਿੰਦੇ ਹੋ?","q7":"ਹਰ ਰੋਜ਼ ਦਵਾਈ ਲੈਣਾ ਕੁਝ ਲੋਕਾਂ ਲਈ ਸੱਚਮੁੱਚ ਔਖਾ ਹੈ। ਕੀ ਤੁਸੀਂ ਕਦੇ ਆਪਣੀ {{COND}} ਇਲਾਜ ਯੋਜਨਾ ਦੀ ਪਾਲਣਾ ਕਰਨ ਤੋਂ ਪਰੇਸ਼ਾਨ ਮਹਿਸੂਸ ਕਰਦੇ ਹੋ?","q8":"ਤੁਹਾਨੂੰ ਆਪਣੀਆਂ ਸਾਰੀਆਂ {{COND}} ਦਵਾਈਆਂ ਲੈਣਾ ਯਾਦ ਰੱਖਣ ਵਿੱਚ ਕਿੰਨੀ ਵਾਰ ਮੁਸ਼ਕਲ ਆਉਂਦੀ ਹੈ?","q1_yes":"ਹਾਂ","q1_no":"ਨਹੀਂ","q8_never":"ਕਦੇ ਨਹੀਂ/ਬਹੁਤ ਘੱਟ","q8_once":"ਕਦੇ-ਕਦਾਈਂ","q8_sometimes":"ਕਦੇ-ਕਦੇ","q8_usually":"ਆਮ ਤੌਰ 'ਤੇ","q8_always":"ਹਰ ਵੇਲੇ"}
};
