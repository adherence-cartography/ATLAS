...
function rebuildConditionDropdown() {
  ...
  const _condUI = {
    ...
    pl: { label: 'Leczona choroba podstawowa <span class="sdoh-optional">opcjonalnie</span>', note: 'Przytrzymaj Ctrl / Cmd, aby wybrać wiele. Twoje wybory pojawią się poniżej.', placeholder: '— Wybierz chorobę —', other: 'Proszę podać chorobę' },
  };
...
async function submitMMAS() {
  ...
  const full = {
    ...
    country:         (typeof _normalizeCountry === 'function' ? _normalizeCountry(sdohCountry) : normalizeCountry(sdohCountry)),
    city:            sdohCity,
  ...
  try {
    ...
    await database.ref('mapData').push({
      ...
      country: (typeof _normalizeCountry === 'function' ? _normalizeCountry(sdohCountry) : sdohCountry) || (hasValidCoords ? userLocation.country : 'Unknown'),
    ...
    if (typeof redcapAutoSyncRecord === 'function') redcapAutoSyncRecord(full);
