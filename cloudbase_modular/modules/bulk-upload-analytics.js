...
const UI_STRINGS = {
  ...
  it: {
    ...
    consent_body: 'Questa valutazione raccoglie informazioni sul suo comportamento di assunzione dei farmaci. Le sue risposte sono riservate e utilizzate solo per la sua assistenza.',
    consent_agree: 'Accetto e Continuo',
    consent_decline: 'Non Ora',
    zoe_greeting: 'Ciao! Sono ZOE, la sua guida all\'aderenza.',
    zoe_start: 'Inizia Valutazione',
    zoe_next: 'Avanti',
    zoe_submit: 'Invia',
    result_title: 'Il Suo Profilo di Aderenza',
    result_high: 'Alta Aderenza',
    result_medium: 'Aderenza Moderata',
    result_low: 'Bassa Aderenza',
    result_tip_high: 'Ottimo lavoro. Continui con la sua routine.',
    result_tip_medium: 'Alcune barriere rilevate. Il suo team di cura può aiutare.',
    result_tip_low: 'Diverse barriere rilevate. Si prega di parlare con il suo medico.',
    domain_motivation: 'Motivazione',
    domain_routine: 'Routine',
    domain_access: 'Accesso',
    portal_title: 'Il Suo Percorso di Salute',
    portal_history: 'Storico Valutazioni',
    portal_contact: 'Contatti il Suo Team di Cura',
    lang_label: 'Lingua',
  }
};
