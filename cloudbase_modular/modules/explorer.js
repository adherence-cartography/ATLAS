...
const EXPLORER_STAT_TIPS = {
  ...
  'mc-map-exec':         { label: 'Execution Domain',                text: 'Average Execution (Exec) score — measures real-time adherence performance in the recent assessment window. Questions 1, 5, and 8 load to this domain. High Architecture + low Execution means the patient is behaviorally structured but currently failing — often due to acute disruption, illness, or situational stress.' },
  'mc-map-ctx':          { label: 'Context-Guard Domain',            text: 'Average Context-Guard (Ctx) score — captures how environmental and situational factors shape adherence behavior. Questions 4 and 7 load to this domain; the score is floored at 0.5 so a single contextual barrier cannot collapse the full PE. Low Context-Guard scores indicate that external circumstances — schedule shifts, travel, competing demands — are the primary driver of non-adherence rather than forgetting or motivation.' },
